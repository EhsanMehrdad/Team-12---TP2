...
<h1 class="text-center">Please explore our Latest Products</h1>
  <div class="row" style="margin-top: 30px;">
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        <img src="./images/catimages/ring1.png" alt="">
        <div class="card-body">
          <h3 class="text-center">Hector Ring</h3>
    ...
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        ...
        <div class="card-body">
          <h3 class="text-center">Salvester Pendant</h3>
          <p class="text-center">VVS Diamond Quality</p>
          <div class="star text-center">
            <i class="fa-solid fa-star checked"></i>
            <i class="fa-solid fa-star checked"></i>
    ...
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        ...
        <div class="card-body">
          <h3 class="text-center">Sectum Neckles</h3>
          <p class="text-center">VVS Diamond Quality</p>
          <div class="star text-center">
            <i class="fa-solid fa-star checked"></i>
            <i class="fa-solid fa-star checked"></i>
  ...
  <div class="row" style="margin-top: 30px;">
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        ...
        <div class="card-body">
          <h3 class="text-center">Hector Rings</h3>
          <p class="text-center">VVS Diamond Quality</p>
          <div class="star text-center">
            <i class="fa-solid fa-star checked"></i>
            <i class="fa-solid fa-star checked"></i>
    ...
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        ...
        <div class="card-body">
          <h3 class="text-center">Salvester Pendants</h3>
          <p class="text-center">VVS Diamond Quality</p>
          <div class="star text-center">
            <i class="fa-solid fa-star checked"></i>
            <i class="fa-solid fa-star checked"></i>
  ...
  <div class="row" style="margin-top: 30px;">
    ...
    <div class="col-md-3 py-3 py-md-0">
      <div class="card">
        ...
        <div class="card-body">
          <h3 class="text-center">Sofia Earring</h3>
          <p class="text-center">Diamond Colours</p>
          <div class="star text-center">
            <i class="fa-solid fa-star checked"></i>
            <i class="fa-solid fa-star checked"></i>
